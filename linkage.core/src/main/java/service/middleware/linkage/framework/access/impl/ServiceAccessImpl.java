...
public class ServiceAccessImpl implements ServiceAccess {
	...
	public ServiceRequestResult requestService(String clientID, List<String> args, ServiceInformation serviceInformation) {
		return requestService(clientID, args, serviceInformation, true);
	}

	@Override
	public ServiceRequestResult requestServicePerConnect(String clientID,
			List<String> args, ServiceInformation serviceInformation) {
		// TODO Auto-generated method stub
		return requestService(clientID, args, serviceInformation, false);
	}

	@Override
	public ServiceRequestResult requestServicePerConnectSync(String clientID,
			List<String> args, ServiceInformation serviceInformation) {
		ServiceRequestResult result = requestService(clientID, args, serviceInformation, false);
	...
	public ServiceRequestResult requestService(String clientID, List<String> args,
		...
		ServiceRequest objRequestEntity = serviceEngine.createRequestEntity(clientID, args);
